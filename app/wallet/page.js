        ...
        <div className="grid md:grid-cols-3 grid-cols-1 gap-12 md:gap-[89px]">
          <div className="flex flex-col pt-4 pb-0">
            <div className="relative">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 mr-2 mt-1">
                  <path id="Vector" d="M6 21H18M12 3V17M12 17L17 12M12 17L7 12" stroke="#14130a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Download
              </a>
            </div>
          ...
          <div className="flex flex-col pt-4 pb-0">
            <div className="relative">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="w-4 h-4 mr-2 mt-1">
                  <circle cx="12" cy="12" r="9" stroke="#14130a" strokeWidth="2"/>
                  <path d="M2.05 12h19.9" stroke="#14130a" strokeWidth="2" strokeLinecap="round"/>
                  <path d="M12 2.05c2.5 2.5 4 6 4 9.95s-1.5 7.45-4 9.95M12 2.05c-2.5 2.5-4 6-4 9.95s1.5 7.45 4 9.95" stroke="#14130a" strokeWidth="2" strokeLinecap="round"/>
                </svg>
                Access
              </a>
            </div>
