...
const Page = () => {
  const totalPages = 5; // Total number of tokenomics explanation images
  ...
  const tokenomicsImages = Array.from({ length: totalPages }, (_, i) => 
    `/tokenomics-images/AIPG_Tokenomics-${i + 1}.png`
  );
      ...
      <main className="flex-grow text-center">
        ...
        <section className="pt-16 pb-16">
          ...
          <div className="hidden sm:block text-center">
            <embed src="/AIPG_Tokenomics.pdf" type="application/pdf" className="mx-auto" style={{ width: '54%', height: '950px' }} />
          </div>
        </section>
        <section className="pt-16 pb-16">
          <div className="">
