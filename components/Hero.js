        ...
        <div className={`mt-4 flex flex-col sm:flex-row gap-3 justify-center ${contentVisible ? 'fade-in' : 'hidden-initially'}`}>
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="none" stroke="currentColor" stroke-width="3"/>
              <circle cx="12" cy="12" r="3.5" fill="none" stroke="currentColor" stroke-width="3"/>
          ...
          >
            ...
            >
              ...
              <circle cx="72.514" cy="10.648" r="4.235" fill="none" stroke="currentColor" stroke-width="3.913"/>
