        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-orange-500/10 to-amber-500/10 border border-orange-500/30 rounded-2xl p-8 relative overflow-hidden">
            ...
            <p className="text-gray-300 mb-6">
              Run GPU inference and serve AI requests. Earn AIPG for every job you complete.
            </p>

            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2 text-gray-300">
                <span className="text-green-400">✓</span>
                <span>Works with Ollama, vLLM, or any backend</span>
              </div>
              <div className="flex items-center gap-2 text-gray-300">
                <span className="text-green-400">✓</span>
                <span>Minimum stake: 1,000 AIPG</span>
              </div>
              <div className="flex items-center gap-2 text-gray-300">
                <span className="text-green-400">✓</span>
                <span>Earn per request processed</span>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-2xl p-8 relative overflow-hidden">
            ...
            <p className="text-gray-300 mb-6">
              Verify inference results and secure the network. Earn fees for honest validation.
            </p>

            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2 text-gray-300">
                <span className="text-blue-400">◇</span>
                <span>Verify worker outputs</span>
              </div>
              <div className="flex items-center gap-2 text-gray-300">
                <span className="text-blue-400">◇</span>
                <span>Minimum stake: 10,000 AIPG</span>
              </div>
              <div className="flex items-center gap-2 text-gray-300">
                <span className="text-blue-400">◇</span>
                <span>Earn verification fees</span>
              </div>
            </div>
